...
namespace MvvmExample
{
    ...
    {
        /// <summary>
        /// Notifies when the property of this class changes
        /// </summary>
        ...
        private void HandleStudentPropertyChanged(object? sender, PropertyChangedEventArgs e)
        {
            if (e.PropertyName == nameof(Student.GPA))
            {
                ...
                PropertyChanged?.Invoke(this, new PropertyChangedEventArgs(nameof(Student.GPA)));
            }
        }
        /// <summary>
        /// constructs a new ComputerScienceStudentModel
        /// </summary>
